...
function initPreload(){
	...
	manifest=[
			...
			{src:'assets/item_ground.png', id:'itemGround'},
			{src:'assets/item_copter.png', id:'itemCopter'},
			{src:'assets/item_pipe.png', id:'itemPipe'},
	...
	for(var n=0; n<pipe_arr.length; n++){
		manifest.push({src:pipe_arr[n], id:'itemPipe'+n});
	}

	for(var n=0; n<cloud_arr.length; n++){
		manifest.push({src:cloud_arr[n], id:'itemCloud'+n});
	}

	for(var n=0; n<mountain_arr.length; n++){
		manifest.push({src:mountain_arr[n], id:'itemMountain'+n});
	}
	...
	if(soundOn){
		...
		manifest.push({src:'assets/sounds/sound_crash.ogg', id:'soundCrash'});
		manifest.push({src:'assets/sounds/sound_copter.ogg', id:'soundCopter'});
